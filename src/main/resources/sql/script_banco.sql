...
CREATE TABLE IF NOT EXISTS plano_acao (
                                          ...
                                          criador_id INT NOT NULL REFERENCES colaborador(colaborador_id)
);
...
CREATE TABLE IF NOT EXISTS plano_acao5w2h (
                                              ...
                                              "where" VARCHAR(50),
                                              "when" DATE,
                                              who INT NOT NULL REFERENCES colaborador(colaborador_id),
                                              how VARCHAR(50),
                                              how_much NUMERIC,
...
CREATE TABLE IF NOT EXISTS licoes_aprendidas (
                                                 ...
                                                 ciclo_id INT REFERENCES ciclo(ciclo_id)
);
