...
-- Colaborador
INSERT INTO colaborador (nome, sobrenome, area, cargo, dt_contratacao, email, senha, telefone, cpf, id_empresa)
...
-- Ciclo
INSERT INTO ciclo (nome, dt_inicio, id_empresa, id_responsavel)
...
-- Plano de ação
INSERT INTO plano_acao (nome, descricao, id_ciclo, id_criador)
...
-- 5W2H
INSERT INTO plano_acao5w2h (what, why, "where", "when", who, how, how_much, id_plano_acao)
...
-- Meta
INSERT INTO meta (meta, descricao_meta, objetivo, prazo, id_ciclo)
...
-- Tarefa
INSERT INTO tarefa (titulo, descricao, dt_entrega, id_colaborador, id_plano_acao)
...
-- Problema
INSERT INTO problema (titulo, descricao, solucao, status, origem, encontrado_em, id_ciclo, id_plano_acao, id_colaborador)
...
-- Ciclo_Colaborador
INSERT INTO ciclo_colaborador (id_ciclo, id_colaborador)
VALUES (1, 1);
...
-- Empresa_Administrador_Geral
INSERT INTO empresa_administrador_geral (id_empresa, id_adm_geral)
VALUES (1, 1);
